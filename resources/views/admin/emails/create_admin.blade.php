...
<head>
    ...
    <title>Registrácia administrátora</title>
    <style type="text/css">
...
<table width="100%" bgcolor="#dbf0ff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="separator">
    <tbody>
    <tr>
        <td>
...
<table width="100%" bgcolor="#dbf0ff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="banner">
    <tbody>
    <tr>
        <td>
                    ...
                    <td width="100%">
                        <table width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <div class="imgpop">
                                        <a href="#"><img width="600" border="0" height="300" st-image="banner" alt=""
                                                         style="display:block; border:none; outline:none; text-decoration:none;"
                                                         src="{{asset('public/img/register-admin.png')}}" class="banner"
                                                         id="1tud118y8wn"></a>
                                    </div>
                                </td>
                            </tr>
...
<table width="100%" bgcolor="#dbf0ff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="full-text">
    <tbody>
    <tr>
        <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hasbackground="true"
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;"
                                                ...
                                                <p style="text-align: left;">
                                                    boli ste zaregistrovaný ako administrátor pre: <a
                                                            href="{{action('Blog\HomeController@index')}}">Blogin</a>
                                                </p>
                                                <p style="text-align: left;">
                                                    Vaše heslo je: {{$pass}}
                                                </p>
                                                <p style="text-align: left;">
                                                    Prihlásiť sa môžte <a href="{{action('Admin\Auth\AuthController@getLogin')}}">tu.</a>
                                                </p>
                                            </td>
                                        </tr>
                                        <!-- End of content -->
...
<table width="100%" bgcolor="#dbf0ff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="footer">
    <tbody>
    <tr>
        <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hasbackground="true">
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                            ...
                            <tr>
                                <td align="center" valign="middle"
                                    ...
                                    <p>
                                        Váš <a href="{{action('Blog\HomeController@index')}}">Blogin</a>
                                    </p>
                                </td>
                            </tr>
                            <!-- Spacing -->
