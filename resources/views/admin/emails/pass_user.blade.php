...
<head>
    ...
    <title>Generovanie nového hesla</title>
    <style type="text/css">
                                ...
                                <td align="center">
                                    <div class="imgpop">
                                        <a href="#"><img width="600" border="0" height="300" st-image="banner" alt=""
                                                         ...
                                                         src="{{asset('public/img/password.png')}}" class="banner"
                                                         id="1tud118y8wn"></a>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;"
                                                ...
                                                <p style="text-align: left;">
                                                    administrátor  Vám vygeneroval nové heslo do: <a
                                                ...
                                                <p style="text-align: left;">
                                                    Prihlásiť sa môžte <a href="{{action('Blog\Auth\AuthController@getLogin')}}">tu.</a>
                                                </p>
                                            </td>
                                        </tr>
                                        <!-- End of content -->
