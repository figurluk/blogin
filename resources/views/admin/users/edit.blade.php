            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{$user->name}}" tabindex="1"
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="checkbox">
                        <label>
                            {!! Form::hidden('admin', 0) !!}
                            {!! Form::checkbox('admin', 1, $user->admin) !!} <b>Administrátor</b>
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                            {!! Form::hidden('password', 0) !!}
                            {!! Form::checkbox('password', 1, null) !!} <b>Poslať nové heslo</b>
                        </label>
                    </div>
                </div>
            </div>
