            ...
            <div class="col-md-5">
                ...
                <div class="row">
                    <div class="col-md-12 main-article2 articleDiv" article="{{$secondSub->code}}">
                        <img src="{{action('Blog\ArticlesController@getImage',$secondSub->code)}}" alt="article image">
        ...
        <div class="row sub-articles-list">
            <div class="col-md-4">
                <div class="sub-article articleDiv" article="{{$firstSubSub->code}}">
                    <img src="{{action('Blog\ArticlesController@getImage',$firstSubSub->code)}}" alt="article image">
            ...
            <div class="col-md-4">
                <div class="sub-article articleDiv" article="{{$secondSubSub->code}}">
                    <img src="{{action('Blog\ArticlesController@getImage',$secondSubSub->code)}}" alt="article image">
            ...
            <div class="col-md-4">
                <div class="sub-article articleDiv" article="{{$thirdSubSub->code}}">
                    <img src="{{action('Blog\ArticlesController@getImage',$thirdSubSub->code)}}" alt="article image">
