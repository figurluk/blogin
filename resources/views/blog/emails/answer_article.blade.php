...
<head>
    ...
    <title>Komentovaný článok</title>
    <style type="text/css">
                                ...
                                <td align="center">
                                    <div class="imgpop">
                                        <a href="#"><img width="600" border="0" height="300" st-image="banner" alt=""
                                                         ...
                                                         src="{{asset('public/img/article-answer.png')}}" class="banner"
                                                         id="1tud118y8wn"></a>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;"
                                                ...
                                                <p style="text-align: left;">
                                                    Váš članok {{$comment->articles->title}} bol komentovaný používateľom {{$comment->user->name}} {{$comment->user->surname}}.
                                                </p>
                                                <p style="text-align: left;">
                                                    Prečítať si ho môžte <a href="{{action('Blog\ArticlesController@show',$comment->articles->code)}}">tu.</a>
                                                </p>
                                            </td>
                                        </tr>
                                        <!-- End of content -->
