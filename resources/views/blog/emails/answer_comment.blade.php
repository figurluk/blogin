...
<head>
    ...
    <title>Komentovaný komentár</title>
    <style type="text/css">
                                ...
                                <td align="center">
                                    <div class="imgpop">
                                        <a href="#"><img width="600" border="0" height="300" st-image="banner" alt=""
                                                         ...
                                                         src="{{asset('public/img/answer-comment.png')}}" class="banner"
                                                         id="1tud118y8wn"></a>
                                    </div>
                                </td>
                            </tr>
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;"
                                                ...
                                                <p style="text-align: left;">
                                                    Dobrý
                                                    deň {{$commented_comment->user->name}} {{$commented_comment->user->surname}},
                                                </p>
                                                <p style="text-align: left;">
                                                    Váš komentár k článku {{$comment->articles->title}} bol komentovaný
